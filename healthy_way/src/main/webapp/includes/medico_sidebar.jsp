<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark"
	...
	<ul class="nav nav-pills flex-column mb-auto">
		<li><a href="medico.jsp" class="nav-link text-white"> <svg
					class="bi me-2" width="16" height="16">
						<use xlink:href="#table"></use></svg> Inicio
		</a></li>
		<li><a href="medico-consulta?acao=listarMedicoConsulta" class="nav-link text-white"> <svg
					class="bi me-2" width="16" height="16">
	...
	<div class="dropdown">
		<a href="#"
			...
			height="32" class="rounded-circle me-2"> <strong>Opções</strong>
		</a>
